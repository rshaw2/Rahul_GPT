...
using RahulGPT.Models;
using RahulGPT.Data;
using RahulGPT.Filter;
using RahulGPT.Entities;
using RahulGPT.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace RahulGPT.Controllers
{
    /// <summary>
    ...
    {
        private readonly RahulGPTContext _context;

        public RoleEntitlementController(RahulGPTContext context)
        {
            _context = context;
        }
