...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "RahulGPT", Version = "v1" });
...
builder.Services.AddTransient<RahulGPTContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "RahulGPT API v1");
